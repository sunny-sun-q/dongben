...
import { treeStore, dataMaintainStore, comboxStore, seniorSearchStore } from './stores/store'
const render = (Component) => {
  ReactDOM.render(
    <AppContainer >
      <IntlProvider locale={locale.replace(/_.+/ig,'')} messages={chooseLocale(locale)}>
        <Provider treeStore={treeStore} dataMaintainStore={dataMaintainStore} comboxStore={comboxStore} seniorSearchStore={seniorSearchStore}>
          <Component />
        </Provider>
      </IntlProvider>
    </AppContainer>,
