...
import imgUrl from '../../../../../assets/images/nodata_distribution.png';
        ...
        <section className="section-wrap">
          ...
          <div className="section-wrap-r">
          {
              ...
              <div className="no-data-display">
                    ...
                    <div className="word">
                      <FormattedMessage id="js.rou.datadistribution.00221" defaultMessage="分类界面无法进行数据分发，您需要到具体模型中进行数据分发处理" />
                    </div>
                    <div className="desc">
                      ...
                      <div className="desc-content">
                        ...
                        <div className="desc-content-div">
                          ...
                          <span className="desc-content-span">2、选择目标系统</span>
                        </div>
                        <div className="desc-content-div">
                          <img src={imgUrl3} className="desc-content-img"></img>
                          <span className="desc-content-span">3、选择数据人工进行分发</span>
                        </div>
                        <div className="desc-content-div">
                          <img src={imgUrl4} className="desc-content-img"></img>
                          <span className="desc-content-span">4、分发成功</span>
                        </div>
                      </div>
                    </div>
                </div>: null
