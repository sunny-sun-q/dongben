...
import { treeStore, comboxStore, distributeStore , seniorSearchStore } from './stores/store'
const render = (Component) => {
  ReactDOM.render(
    <AppContainer >
      <IntlProvider locale={locale.replace(/_.+/ig,'')} messages={chooseLocale(locale)}>
        <Provider treeStore={treeStore} comboxStore={comboxStore} distributeStore={distributeStore} seniorSearchStore={seniorSearchStore}>
          <Component />
        </Provider>
      </IntlProvider>
    </AppContainer>,
