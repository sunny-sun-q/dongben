...
import { treeStore, bakEntityContentStore, comboxStore } from './stores/store'
const render = (Component) => {
  ReactDOM.render(
    <AppContainer >
      <IntlProvider locale={locale.replace(/_.+/ig,'')} messages={chooseLocale(locale)}>
        <Provider treeStore={treeStore} bakEntityContentStore={bakEntityContentStore} comboxStore={comboxStore}>
          <Component />
        </Provider>
      </IntlProvider>
    </AppContainer>,
