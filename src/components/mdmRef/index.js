...
class MdmRefComp extends Component {
    ...
    initComponent = (nextProps) => {
        ...
        if(propsObj.pk_entityitem && propsObj.pk_gd){
            request(`/modeling/mdmshow/card/reference`,{
                method: "GET",
                param: {
            ...
            request(`/modeling/mdmshow/card/reference/archives`,{
                method: "GET",
                param: {
    ...
    getDataFun = (key, treeNodePk) => {
        ...
        if(this.props.authfilter){
            params.authfilter = true
        }
        request(url,{
            method: "GET",
            param: params
            ...
            let tableData = [];
            let treeData = [];
            let gridDataObj,treeDataObj,pkField,writeField,treePkField,treeWriteField;
            if(type === 'grid'){
            ...
            if(type === 'tree'  || type === 'treegrid'){
                ...
                if(type === 'treegrid'){
                    ...
                    treePkField = treeDataObj.pkField;
                    treeWriteField = treeDataObj.writeField;
                }
            ...
            function transData(data) {    
                ...
                function group(nodes) {
                  ...
                  for (var i = 0; i < nodes.length; i++) {
                    if(type === 'treegrid'){
                      nodes[i][writeField] = nodes[i][treeWriteField];
                    }
                    if (nodes[i][pidField]) {
            ...
            this.setState({
                ...
                treePkField: treePkField,
                treeWriteField: treeWriteField,
    ...
    getRender(props,refProps){
        ...
        if(type === 'grid'){
            ...
            // console.log('tree',props,refProps)
    ...
    render() {
        ...
        return (
          <div className={this.props.className || 'mdm-ref-whole'}>
              { 
